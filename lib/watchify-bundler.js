...
// a bit icky; but allows us to modify 
// process.argv and stderr/stdout
var browserifyBuiltins = require('browserify/lib/builtins')
var patchedBuiltins = assign({}, browserifyBuiltins)
patchedBuiltins._process = require.resolve('./process-browser.js')
